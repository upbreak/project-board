...
class UserAccountServiceTest {
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("jinwoo");
        UserAccount savedUserAccount = createSigningUpUserAccount("jinwoo");
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("createBy", userAccount.getUserId())
