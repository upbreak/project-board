...
class PaginationServiceTest {
    ...
    @DisplayName("현재 페이지 번호와 총 페이지 수를 주면, 페이징 바 리스트를 준다.")
    @MethodSource
    ...
    static Stream<Arguments> givenCurrentPageNumberAndTotalPages_whenCalculating_thenReturnPaginationBarNumbers(){
        return Stream.of(
                arguments(0, 4, List.of(0, 1, 2))
                , arguments(1, 4, List.of(0, 1, 2))
                , arguments(2, 4, List.of(1, 2, 3))
                , arguments(3, 4, List.of(2, 3))
        );
    }
    ...
    void givenNothing_whenCalling_thenReturnsCurrentBarLength() {
        ...
        // Then
        assertThat(barLength).isEqualTo(3);
    }
}